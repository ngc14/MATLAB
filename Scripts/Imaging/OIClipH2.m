%  [imresult, frameMedian, LowClip, HighClip]=OIClipH(imin, method, value, immask)
...
%         9: clip to specific values (value = [low high])
...
function [imresult, frameMedian, lowClip, highClip]=OIClipH2(imin, method, value, immask)
...
case 1    % 1: clipping to median +-SD (value) 
    ...
    frameMedian=nanmedian(temp);    
    frameStd=nanstd(temp);
...
%     usefulpixels=combined(1:maskpixelnum, 1);
    ...
    usefulpixels = imin(immask>0);
    
    frameMedian=nanmedian(usefulpixels);
