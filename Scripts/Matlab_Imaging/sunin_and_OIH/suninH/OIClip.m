%  [imresult, frameMedian, LowClip, HighClip]=OIClip(imin, method, value, immask, value2)
...
%           4: clipping by certain values (value), not +-SD
%           5: clipping by percentile (i.e. x% pixels above and below median value)     --need add
