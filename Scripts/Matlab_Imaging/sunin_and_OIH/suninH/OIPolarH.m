function Polarmap=OIPolar(singlemap, lut, mask, clipsd, lowpass, highpass, LPfiltermethod, HPfiltermethod)

% Modified 071021 Hisashi
% Modified 051007 HDL
...
for k = 1:n;
	...
	if highpass ~=0
        ...
        switch HPfiltermethod 
            ...
            case 'ribot'
                singlemap(:,:,k) = singlemap(:,:,k)-RibotFilter(singlemap(:,:,k), highpass);   % note HPFKernel here is actually order of polynomial function, usually 2 or 3
            otherwise
                printf('Error: please specify filting method, no filtering performed\r');
        end
	end
