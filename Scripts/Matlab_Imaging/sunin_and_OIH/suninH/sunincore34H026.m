...
switch precisiontype %by Hisashi
    case 'single'
        ...
        if flagsp==1
            spvalues=NaN(FramesPerStim+2,masknum,NStim,blockselectnum, 'single');
        end
    ...
    case 'double'
        ...
        stimsumnum=zeros(NStim,1);	%keep how many stim was summed. (in randomized & goodstim cases, it may not same for each condition).
        if flagsp==1
            spvalues=NaN(FramesPerStim+2,masknum,NStim,blockselectnum);
        end
        if (flagsaveaverageblk & datasource~=3)
...
%                 temptime=blockproctime/counter2*sum(sum(goodstim))*(blockselectnum/blockfilenum)*(stimselectnum/NStim);
...
%     spvalues=reshape(spvalues, FramesPerStim+2,masknum,NStim,max(stimsumnum));     % don't know why this is necessory
    ...
    spavg=zeros(FramesPerStim+2, masknum, NStim);
	spstd=zeros([FramesPerStim+2, masknum, NStim]);	
    for i=1:NStim  
    ...
    if flagspcond==1
        for j=NStim+1:NStim+NSPcond
            ...
            n=1;
            SPcondsum=zeros(FramesPerStim+2,masknum);
            SPcondnum=0;
            for i=condlist1
...
%             j-NStim
    ...
    spavg=reshape(spavg, [FramesPerStim+2, masknum, NStim+NSPcond]);
    spstd=reshape(spstd, [FramesPerStim+2, masknum, NStim+NSPcond]);
    ...
    fprintf(superfida1, '\r\r_______________SD_________\r\t');
    fprintf(superfida1, '%f\t', xlabel);
    fprintf(superfida1, 'fframe\t');
    fprintf(superfida1, 'sumrange%d\t');
    fprintf(superfida1, '\r');
    ...
    fprintf(superfida1, '\r\r_______________Num_________\r\t');
    fprintf(superfida1, '%f\t', xlabel);
    fprintf(superfida1, 'fframe\t');
    fprintf(superfida1, 'sumrange%d\t');
    fprintf(superfida1, '\r');
    ...
    fprintf(superfida1, '\r\r_______________SEM_________\r\t');
    fprintf(superfida1, '%f\t', xlabel);
    fprintf(superfida1, 'fframe\t');
    fprintf(superfida1, 'sumrange%d\t');
    fprintf(superfida1, '\r');
    ...
    fprintf(superfida2, 'fframe\t');
    fprintf(superfida2, 'sumrange%d\t');
    ...
    fprintf(superfida2, '\r\r_______________SD_________\r\t');
    fprintf(superfida2, '%f\t', xlabel);
    fprintf(superfida2, 'fframe\t');
    fprintf(superfida2, 'sumrange%d\t');
    fprintf(superfida2, '\r');
    ...
    fprintf(superfida2, '\r\r_______________Num_________\r\t');
    fprintf(superfida2, '%f\t', xlabel);
    fprintf(superfida2, 'fframe\t');
    fprintf(superfida2, 'sumrange%d\t');
    fprintf(superfida2, '\r');
    ...
    fprintf(superfida2, '\r\r_______________SEM_________\r\t');
    fprintf(superfida2, '%f\t', xlabel);
    fprintf(superfida2, 'fframe\t');
    fprintf(superfida2, 'sumrange%d\t');
    fprintf(superfida2, '\r');
...
%     superfid3a= fopen(strcat(resultfolder, strcat('superpixeldRR3', '.txt')), 'w');  
    spvalues2=spvalues;
    spavg2=zeros(FramesPerStim+2, masknum, NStim);
	spstd2=zeros(FramesPerStim+2, masknum, NStim);	
   	for i=1:NStim
    ...
    spavg2=reshape(spavg2, [FramesPerStim+2, masknum, NStim+NSPcond]);
    spstd2=reshape(spstd2, [FramesPerStim+2, masknum, NStim+NSPcond]);

    % superpix1 (same mask are grouped together)
    fprintf(superfidb1, 'dR/R value\t');
    fprintf(superfidb1, '%f\t', xlabel);
    fprintf(superfidb1, 'fframe\t');
    fprintf(superfidb1, 'sumrange%d\t');
    ...
    fprintf(superfidb1, '\r\r_______________SD_________\r\t');
    fprintf(superfidb1, '%f\t', xlabel);
    fprintf(superfidb1, 'fframe\t');
    fprintf(superfidb1, 'sumrange%d\t');
    fprintf(superfidb1, '\r');
    ...
    fprintf(superfidb1, '\r\r_______________Num_________\r\t');
    fprintf(superfidb1, '%f\t', xlabel);
    fprintf(superfidb1, 'fframe\t');
    fprintf(superfidb1, 'sumrange%d\t');
    for (j=1:masknum)
    ...
    fprintf(superfidb1, '\r\r_______________SEM_________\r\t');
    fprintf(superfidb1, '%f\t', xlabel);
    fprintf(superfidb1, 'fframe\t');
    fprintf(superfidb1, 'sumrange%d\t');
    for (j=1:masknum)
    ...
    fprintf(superfidb2, 'fframe\t');
    fprintf(superfidb2, 'sumrange%d\t');
    ...
    fprintf(superfidb2, '\r\r_______________SD_________\r\t');
    fprintf(superfidb2, '%f\t', xlabel);
    fprintf(superfidb2, 'fframe\t');
    fprintf(superfidb2, 'sumrange%d\t');
    fprintf(superfidb2, '\r');
    ...
    fprintf(superfidb2, '\r\r_______________Num_________\r\t');
    fprintf(superfidb2, '%f\t', xlabel);
    fprintf(superfidb2, 'fframe\t');
    fprintf(superfidb2, 'sumrange%d\t');
    fprintf(superfidb2, '\r');
    ...
    fprintf(superfidb2, '\r\r_______________SEM_________\r\t');
    fprintf(superfidb2, '%f\t', xlabel);
    fprintf(superfidb2, 'fframe\t');
    fprintf(superfidb2, 'sumrange%d\t');
    fprintf(superfidb2, '\r');
